...
TELEMETRY_PROTO = os.getenv("TELEMETRY_PROTO", "udp").lower()
...
class UdpDiffController:
    def __init__(self):
        ...
        try:
            ...
            self.depth_downsample = 10
            if self.depth:
                self.depth.enable(16)
            print("depth camera found")
        except Exception as e:
            print("no depth camera", e)
            self.depth = None
